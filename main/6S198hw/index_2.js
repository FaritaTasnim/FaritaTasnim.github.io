...
function mean_pred(y_true, y_pred){
...
async function train() {
  ...
  for (let i = 0; i < NUM_BATCHES; i++) {
    ...
    const catAccuracy = history.history.acc[0];
    ...
    if (validationData != null) {
      ...
      catAccuracyValues.push({'batch': i, 'accuracy': catAccuracy, 'set': 'train'});
      ui.plotAccuracies(catAccuracyValues);
    }
